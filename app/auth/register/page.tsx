          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <Button variant="outline" type="button" onClick={handleGoogleLogin} disabled={isLoading || !agreeToTerms}>
                ...
                <Button variant="outline" type="button" onClick={handleFacebookLogin} disabled={isLoading || !agreeToTerms}>
